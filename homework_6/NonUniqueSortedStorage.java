...
/**
 * This is a class that allows saving any type of object sorted. The number
 * of null values being added and removed are being tracked along with the
 * unique strings. This is a generic class.
 *
 * @author Andrew Serra
 * @author Anindhya Kushagra
 */
public class NonUniqueSortedStorage<T extends Comparable<T>>
        implements SortedStorage<T>,
        Comparable<NonUniqueSortedStorage<T>> {
     ...
     */
    @Override
    public int compareTo(NonUniqueSortedStorage<T> o) {
